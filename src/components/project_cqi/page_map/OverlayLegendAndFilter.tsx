                      ...
                      return (
                        ...
                        >
                          ...
                          {filteringEnabled && (
                            <button
                              className={twJoin(
                                'rounded-md border border-white p-1.5 transition-colors group-hover/focus:border-gray-200 group-hover/focus:bg-blue-50 group-hover/legend:text-gray-800 focus:outline-hidden focus-visible:ring-2 focus-visible:ring-white/75',
