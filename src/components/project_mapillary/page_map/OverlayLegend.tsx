...
export const OverlayLegend = () => {
  ...
  return (
    <div className="px-2 py-4">
      ...
      >
        <summary
          className={twJoin('cursor-pointer text-xs', showFreshImagery ? 'hover:underline' : '')}
        >
          Gestrichelt: Fotos nach dem {mapillaryDateData ? mapillaryDateData.displayDate : '...'}
        </summary>
        <div className="text-sm">
          Diese Karte zeigt prozessierte Daten, die nur alle paar Wochen aktualisiert werden. Um zu
