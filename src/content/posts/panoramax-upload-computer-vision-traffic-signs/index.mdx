...
showToc: false
---
*How we enriched first-pass image annotations with traffic sign classification*
...
<Callout language="en" color="yellow">
  **Note on multiple tags with the same key:**&#x20;
  ...
  ```
  detection_model[osm|traffic_sign=DE:205] = SGBlur-yolo11m/0.1.0detection_confidence[osm|traffic_sign=DE:205] = 0.78
  ```
</Callout>
