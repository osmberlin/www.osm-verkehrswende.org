...
menuTitle: Schulabgleich Launch
...
<ImageSingleHorizontal src="/src/content/posts/schulabgleich/schulabgleich-homepage.min.png" alt="Screenshot: Die Startseite bietet den Einstieg in die Bundesländer." imageConfig={{"discriminant":"fit"}} />
